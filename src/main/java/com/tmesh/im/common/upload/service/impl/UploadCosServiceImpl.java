...
public class UploadCosServiceImpl extends UploadBaseService implements UploadService {
    ...
    private COSClient initCOS() {
        return new COSClient(new BasicCOSCredentials(this.uploadConfig.getAccessKey(), this.uploadConfig.getSecretKey()),
                new ClientConfig(new Region(this.uploadConfig.getRegion())));
    }
